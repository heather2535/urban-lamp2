  ...
  return createPortal(
    <div className="mt-4 flex flex-col items-center">
      ...
      <div className="mt-2 flex gap-2">
        <button onClick={prev} className="px-2 py-1 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">Prev</button>
        <span className="text-gray-700 dark:text-gray-300">{index + 1} / {images.length}</span>
        <button onClick={next} className="px-2 py-1 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">Next</button>
      </div>
    </div>,
    container
  );
                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-6">
                    <img
                      ...
                      style={{ height: "auto" }}
                    />
                    <h2 className="text-center text-gray-700 dark:text-gray-300 mt-4">User Flow 3: Template Creation and Management</h2>
                  </div>
                  ...
                  <div className="mt-6">
                    <img
                      ...
                      style={{ height: "auto" }}
                    />
                    <h2 className="text-center text-gray-700 dark:text-gray-300 mt-4">Sitemap: Navigation Structure and Information Architecture</h2>
                  </div>
                  ...
                  <div className="mt-8">
                    ...
                    <h2 className="text-center text-gray-700 dark:text-gray-300 mt-4">Initial wireframes showing the submission flow and template management</h2>
                  </div>
